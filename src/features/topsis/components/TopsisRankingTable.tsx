                ...
                return (
                  ...
                  >
                    <td className="py-2.5 px-4 font-semibold">
                      {isTop ? (
                        <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-amber-100 text-amber-800 text-[11px] font-bold border border-amber-300">
                    ...
                    <td className="py-2.5 px-4 font-bold text-slate-800">{row.alternativeName}</td>
